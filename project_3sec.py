...
# 저장된 모델의 최적 epoch 확인
if os.path.exists('best_model_3sec.h5'):
...
history_dict = history_3sec.history  # loss와 dict 형태로 저장되어 있음
print(history_dict.keys())

with open('training_history_3sec.pkl', 'wb') as f:
...
np.savez('predictions3sec_and_labels.npz',
         predictions_3sec=predictions,
         y_test=y_test)
